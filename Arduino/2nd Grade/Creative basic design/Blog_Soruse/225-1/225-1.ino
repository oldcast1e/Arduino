...
#ifndef STASSID
const char* STASSID = "yeokyoung";
const char* STAPSK = "dobudobu";
#endif
...
const char* yourkey = "reLDcB4o3fLJ6nMp3f0BDtErKR23ShF4BScYgMco2cOAHGniys0ZEBNeYKEs9g98uLD8leyOZOC8juTCYgcMDA%3D%3D";
String cityCode="23";
...
void setup() {
  ...
  String url = "/openapi/service/ArvlInfoInqireService/getSttnAcctoArvlPrearngeInfoList?serviceKey="+yourkey+"&cityCode="+cityCode+"&nodeId="+nodeId;
