...
const unsigned char* mapWeatherToBitmap(const char* weatherCode) {
    if (strcmp(weatherCode, "CLR") == 0 || strcmp(weatherCode, "SUN") == 0) {
        return weather_sun;
    } else if (strcmp(weatherCode, "CLD") == 0 || strcmp(weatherCode, "CLOUD") == 0) {
        return weather_cloud;
    } else if (strcmp(weatherCode, "RN") == 0 || strcmp(weatherCode, "RAIN") == 0) {
        return weather_rain;
    } else if (strcmp(weatherCode, "SN") == 0 || strcmp(weatherCode, "SNOW") == 0) {
        return weather_snow;
    } else if (strcmp(weatherCode, "OVC") == 0 || strcmp(weatherCode, "CLOUDY") == 0) {
        return weather_cloudy;
    } else if (strcmp(weatherCode, "WND") == 0 || strcmp(weatherCode, "WIND") == 0) {
        return weather_wind;
    } else {
...
void updateDisplay() {
    ...
    // Draw dividing lines for C and D sections only
    ...
    drawHorizontalLine(middleHorizontalLine);
...
void parseSerialInput(String input) {
    ...
    if (input.startsWith("CW|")) {
        ...
        if (index > 0) {
            int wIndex = input.indexOf("W:", index);
