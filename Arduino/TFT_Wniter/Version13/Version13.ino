...
void updateDisplay() {
    ...
    drawVerticalLine(middleSectionWidth, sectionHeight, 2 * sectionHeight); // Vertical line to separate C and D
    char tempBuffer[8];
    ...
    // Section C: Humidity
    printCenteredText("Humidity", middleSectionWidth, screenWidth, sectionHeight, (3 * sectionHeight) / 2, RED, 2);
    char humidityBuffer[8];
    sprintf(humidityBuffer, "%d%%", humidityC);
    printCenteredText(humidityBuffer, middleSectionWidth, screenWidth, (3 * sectionHeight) / 2, 2 * sectionHeight, BLACK, 2);

    // Section D: State
    printCenteredText("STATE", middleSectionWidth, screenWidth, sectionHeight, (3 * sectionHeight) / 2, BLUE, 2);
    printCenteredText(stateC, middleSectionWidth, screenWidth, (3 * sectionHeight) / 2, 2 * sectionHeight, BLACK, 2);
