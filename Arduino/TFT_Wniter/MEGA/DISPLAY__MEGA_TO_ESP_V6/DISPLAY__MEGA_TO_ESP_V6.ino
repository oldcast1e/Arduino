...
void parseSerialInput(String input) {
    ...
    String timeStr = input.substring(dateTimeSeparator + 1, dateTimeSeparator + 6); // Extract HH:MM
    ...
    // 2. Parse current weather data
    String weatherData = input.substring(dateTimeSeparator + 7); // Extract from CW| onwards
