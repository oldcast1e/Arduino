...
void setup() {
    ...
    Serial1.begin(115200);  // ESP8266과 통신용 시리얼
...
void parseSerialInput(String input) {
    ...
    if (currentWeatherEnd == -1) {
        Serial.println("Error: Current weather format is incorrect.");
        hasError = true;
        return;
    }
    ...
    if (hIndex > 0) {
        ...
        // 입력 값 대신 센서에서 읽은 값 사용
        humidityC = (int)measuredHumidity;
