...
void parseSerialInput(String input) {
    ...
    int timeEnd = input.indexOf("_CW|", timeStart); // Check for "_CW|" to determine time end
    ...
    String weatherData = input.substring(timeEnd + 1); // Extract from CW| onwards
    ...
    // 3. Replace humidity with DHT11 value
    ...
    // 4. Parse future weather data for 'E', 'F', 'G'
    for (int i = 0; i < 3; i++) {
